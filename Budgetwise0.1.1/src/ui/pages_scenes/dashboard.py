...
class Dashboard(ft.View):
    def __init__(self, page: ft.Page, user_data, NavRail, colors):
        super().__init__(route="/dashboard", bgcolor= colors.BLUE_BACKGROUND)
    ...
    def draw_transaction_table(self):
        ...
        if len(transactions) == 0:
            ...
            self.transaction_table.controls.append(
                ft.Row([
                    ft.Text("Vendor", weight="bold", width=150, color=self.colors.TEXT_COLOR, text_align="center", size=15),
