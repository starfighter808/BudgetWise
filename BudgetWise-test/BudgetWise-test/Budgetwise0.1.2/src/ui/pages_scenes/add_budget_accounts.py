...
class AddBudgetAccounts(ft.View):
    def __init__(self, page: ft.Page, user_data, colors):
        ...
        self.importance_rating_field = ft.TextField(label="Importance Rating")
                    ...
                    controls=[
                        ...
                        ft.Row(
                            [
                                ...
                                ft.Container(self.account_type_dropdown, expand=True),
                            ],
                            spacing=10
                        ),
                        ft.Row(
                            [
                                ...
                                ft.Container(self.importance_rating_field, expand=True),
                            ],
                            spacing=10
                        ),
    ...
    def add_account(self, e):
        ...
        importance_rating = self.importance_rating_field.value.strip()
        ...
        self.importance_rating_field.value = ""
        self.description_field.value = ""
        self.account_name_field.update()
        self.account_allocated_field.update()
        self.importance_rating_field.update()
