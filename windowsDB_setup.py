...
def create_encrypted_database():
    ...
    app_data_folder = os.getenv('APPDATA')  # Finding AppData folder
    app_name = 'BudgetWise'  # Folder name
    app_folder = os.path.join(app_data_folder, app_name)
...
def decrypt_database():
    # Get the path to the AppData folder
    app_data_folder = os.getenv('APPDATA')  # This retrieves the AppData folder in Windows
    app_name = 'BudgetWise'  
    app_folder = os.path.join(app_data_folder, app_name)
    ...
    password = keyring.get_password('BudgetWise', 'db_password')
    if password is None:
        return(print("No password found. Please create the database first."))
