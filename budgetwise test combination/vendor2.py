...
class Vendor:
    ...
    def createVendor(self, userID, vName, vDesc):
        try:
    ...
    def getVendorsByUserID(self, userID):
        try:
    ...
    def updateVendor(self, vendorID, vName, vDesc, vendorUR):
        try:
    ...
    def deleteVendor(self, vendorID):
        try:
    ...
    def getVendorDescription(self, vendorID):
        try:
    ...
    def setVendorDescription(self, vendorID, vDesc):
        try:
    ...
    def getVendorUsageRanking(self, vendorID):
        try:
    ...
    def setVendorUsageRanking(self, vendorID, vendorUR):
        try:
    ...
    def setVendorName(self, vendorID, vName):
        try:
