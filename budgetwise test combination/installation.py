...
class Installation:
    def __init__(self, db_filename="BudgetWise.db", app_name="BudgetWise"):
        ...
        self.os_type = platform.system()  # "Windows", "Darwin" (for macOS), "Linux", etc.
    ...
    def get_app_folder(self):
        ...
        if self.os_type == "Windows":
            ...
            # For Linux or other OS, you can choose a suitable folder.
            #return os.path.join(os.path.expanduser("~"), f".{self.app_name}")
            #still working on linux this is the assumed path it would need have not actually tested it
            return print("not valid os")
    ...
    def create_encrypted_database(self):
        ...
        # Retrieve or generate the secure password
