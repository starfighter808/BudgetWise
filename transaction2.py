...
class Transaction:
    ...
    def createTransaction(userID, budgetID, catID, vendorID, transAmount, description):
        try:
    ...
    def getImportanceRating(transactionID):
        try:
    ...
    def setImportanceRating(transactionID, transIR):
        try:
            #this query will fetch the importance rating of a single transactionID
    ...
    def getRecurring(transactionID):
        try:
            #this query will fetch the importance rating of a single transactionID
    ...
    def setRecurring(transactionID, isRecurring):
        try:
    ...
    def setAmount(transactionID, transAmount):
        try:
    ...
    def getDescription(transactionID):
        try:
    ...
    def setDescription(transactionID, transDesc):
        try:
